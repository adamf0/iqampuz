...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-10 d-flex p-5">
            <h1 class="text-center">Form Tambah Panel Menu</h1>
            <hr>
        </div>
        <div class="col-10 d-flex">
            ...
            @endif
            <form action="{{ route('panel_menu.store') }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-12">
                        ...
                        <select class="form-control" name="id_panel" id="id_panel" onchange="load_menus(this)">
                            ...
                            @foreach($panels as $panel)
                                <option value="{{ $panel->id_panel }}">{{ $panel->nama_panel }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-12">
                        <label>To Menu</label>
                        <input type="text" class="form-control" name="to_menu">
...
<script>
    ...
    function load_menus(id_panel){
        var id_panel = id_panel==""? "":id_panel.options[id_panel.selectedIndex].value;
