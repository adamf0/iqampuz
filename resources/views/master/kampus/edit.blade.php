                    ...
                    <div class="tab-content" id="myTabContent">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6 my-1">
                                        ...
                                        <input type="text" name="nama_kampus"
                                            value="{{ old('nama_kampus') ? old('nama_kampus') : $detail['nama_kampus'] }}"
                                    ...
                                    <div class="col-12 col-md-6 my-1">
                                        ...
                                        <div class="col-6 col-md-3 m-auto">
                                            <img src="images/{{ $detail['logo_kampus'] }}" id="output_logo"
                                    ...
                                    <div class="col-12 col-md-6 my-1">
                                        ...
                                        <input type="text" name="kode_kampus" class="form-control" id="kode"
                                            value="{{ old('kode_kampus') ? old('kode_kampus') : $detail['kode_kampus'] }}">
                                    </div>
                                    <div class="col-12 col-md-6 my-1">
                                        ...
                                        <input type="text" name="singkatan_kampus" class="form-control"
                                            id="singkatan_kampus"
                                            value="{{ old('singkatan_kampus') ? old('singkatan_kampus') : $detail['singkatan_kampus'] }}">
                                    </div>
                                    <div class="col-12 col-md-6 my-1">
                                        <label for="kode_pt" class="form-label">Kode Pt</label>
                                        <input type="text" name="kode_pt" class="form-control"
                                            value="{{ old('kode_pt') ? old('kode_pt') : $detail['kode_pt'] }}"
                                            id="kode_pt">
                                    </div>
                                    <div class="col-12 col-md-6 my-1">
                                        ...
                                        <input type="date" name="tanggal_berdiri" class="form-control"
                                            id="tanggal_berdiri"
                                            value="{{ old('tanggal_berdiri') ? old('tanggal_berdiri') : $detail['tgl_berdiri'] }}">
                                    </div>
                                    <div class="col-12 col-md-6 my-1">
                                        <label for="provinsi" class="form-label">Provinsi</label>
                                        <select class="provinsi js-example-responsive form-select" name="provinsi"
                                            id="provinsi">
                                            <option value="{{ old('provinsi') ? old('provinsi') : $detail['provinsi'] }}">
                                                {{ old('provinsi') ? old('provinsi') : $detail['provinsi'] }}</option>
                                        </select>
                                    </div>
                                    <div class="col-12 col-md-6 my-1">
                                        <label for="kota" class="form-label">Kota</label>
                                        <select name="kota" class="kota js-example-responsive form-select"
                                            id="kota">
                                            <option value="{{ old('kota') ? old('kota') : $detail['kota'] }}">
                                                {{ old('kota') ? old('kota') : $detail['kota'] }}</option>
                                        </select>
                                    </div>
                                    <div class="col-12 col-md-6 my-1">
                                        <label for="kode_pos" class="form-label">Kode Pos</label>
                                        <input type="text" name="kode_pos"
                                            value="{{ old('kode_pos') ? old('kode_pos') : $detail['kodepos'] }}"
                                    ...
                                    <div class="col-12 col-md-6 my-1">
                                        ...
                                        <input type="text" name="faximile" class="form-control"
                                            value="{{ old('faximile') ? old('faximile') : $detail['faximile'] }}"
                                            id="faximile">
                                    </div>
                                    <div class="col-12 col-md-6 my-1">
                                        ...
                                        <select class="akreditasi_kampus js-example-responsive form-select"
                                            ...
                                            @if (old('akreditasi_kampus'))
                                                <option selected value="{{ old('akreditasi_kampus') }}">
                                                    {{ old('akreditasi_kampus') }}</option>
                                                @foreach ($akreditasi as $akre_kampus)
                                                    <option value="{{ $akre_kampus }}">{{ $akre_kampus }}</option>
                                                @endforeach
                                            @endif
                                            <option selected value="{{ $detail['akreditasi'] }}">
                                                {{ $detail['akreditasi'] }}</option>
                                            @foreach ($akreditasi as $akre_kampus)
                                                <option value="{{ $akre_kampus }}">{{ $akre_kampus }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12 col-md-6 my-1">
                                        ...
                                        <input type="text" name="telepon"
                                            value="{{ old('telepon') ? old('telepon') : $detail['telepon'] }}"
                                            class="form-control" id="telepon">
                                    </div>
                                    <div class="col-12 col-md-6 my-1">
                                        <label for="email" class="form-label">Email</label>
                                        <input type="text" name="email" class="form-control" id="email"
                                            value="{{ old('email') ? old('email') : $detail['email'] }}">
                                    </div>
                                    <div class="col-12 col-md-6 my-1">
                                        <label for="website" class="form-label">Website</label>
                                        <input type="text" name="website" class="form-control"
                                            value="{{ old('website') ? old('website') : $detail['website'] }}"
                                            id="website">
                                    </div>

                                    <div class="col-12 col-md-6 my-1">
                                        <label for="tgl_kerjasama" class="form-label">Tanggal Kerja Sama</label>
                                        <input type="date" name="tgl_kerjasama"
                                            value="{{ old('tgl_kerjasama') ? old('tgl_kerjasama') : $detail['tgl_kerjasama'] }}"
                                    ...
                                    <div class="col-12 col-md-6 my-1">
                                        ...
                                        <input type="text" name="nama_rektor"
                                            value="{{ old('nama_rektor') ? old('nama_rektor') : $detail['nama_rektor'] }}"
                                    ...
                                    <div class="col-12 col-md-6 my-1">
                                        ...
                                        <div class="col-6 m-auto">
                                            <img src="images/{{ $detail['foto_rektor'] }}" id="output_rektor"
                                                class="img-fluid" />
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 my-1">
                                        ...
                                        <input type="file" name="foto_kampus" accept="image/*"
                                            onchange="loadFile(event,'output_kampus')" class="form-control"
                                            id="foto_kampus">
                                        <div class="col-6 m-auto">
                                            <img src="images/{{ $detail['foto_kampus'] }}" id="output_kampus"
                                                class="img-fluid" />
                                        </div>
                                    </div>
                                    <div class="col-12 my-1">
                                        <label for="alamat" class="form-label">Alamat kampus</label>
                                        <textarea class="form-control" name="alamat_kampus" id="alamat" rows="3">{{ old('alamat_kampus') ? old('alamat_kampus') : $detail['alamat_kampus'] }}</textarea>
                                    </div>
                                    <div class="col-12 my-1">
                                        <label for="profil_kampus" class="form-label">Profil kampus</label>
                                        <textarea class="form-control" name="profil_kampus" id="profil_kampus" rows="3">{{ old('profil_kampus') ? old('profil_kampus') : $detail['profil_kampus'] }}</textarea>
                                    </div>
                                    ...
                                    <div class="col-12 my-1">
                                        ...
                                        <input type="color" name="warna_kampus"
                                            ...
                                            value="{{ old('warna_kampus') ? old('warna_kampus') : $detail['warna_kampus'] }}"
                                            id="warna_kampus">
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex justify-content-end">
                                <a class="btn btn-success next fw-semibold">Next Step <i
                        ...
                        <div class="tab-pane fade mb-5" role="tabpanel" id="step2" aria-labelledby="step2-tab">
                            <div class=" shadow-sm mb-3 p-4">
                                @php
                                    $keterangan = json_decode($detail['keterangan']);
                                @endphp
                                <h4 class="my-3">Sejarah</h4>
                                <textarea name="sejarah" class="texteditor" name="sejarah" cols="30" rows="10">{{ old('sejarah') ? old('sejarah') : $keterangan->sejarah }}</textarea>
                                <h4 class="my-3">Visi</h4>
                                <textarea name="visi" class="texteditor" name="visi" cols="30" rows="10">{{ old('visi') ? old('visi') : $keterangan->visi }}</textarea>
                                <h4 class="my-3">Misi</h4>
                                <textarea name="misi" class="texteditor" name="misi" cols="30" rows="10">{{ old('misi') ? old('misi') : $keterangan->misi }}</textarea>
                                <h4 class="my-3">Slogan</h4>
                                <textarea class="form-control" name="slogan" rows="3">{{ old('slogan') ? old('slogan') : $keterangan->slogan }}</textarea>
                                <h4 class="my-3"><label for="youtube">Youtube</label></h4>
                                <input type="text" class="form-control" name="youtube" placeholder="youtube"
                                    id="youtube" value="{{ old('youtube') ? old('youtube') : $keterangan->youtube }}">
                            </div>
                        ...
                        <div class="tab-pane fade" role="tabpanel" id="step3" aria-labelledby="step3-tab">
                            <div class=" mb-3 shadow-sm p-4">
                                ...
                                @php
                                    foreach (json_decode($detail['prodi']) as $pro) {
                                        $data[] = explode('|', $pro);
                                    }
                                @endphp
                                <div class="row my-3" id="a">
                                    @foreach ($data as $fixprodi)
                                        <div class="col-6">


                                            <select class="prodi js-example-responsive form-select" name="prodi[]"
                                                style="width: 100%">
                                                <option selected value="{{ $fixprodi[1] }}">{{ $fixprodi[1] }}</option>
                                                @foreach ($jurusan as $jur)
                                                    <option value="{{ $jur['idx'] }}">{{ $jur['text'] }}</option>
                                                @endforeach
                                                {{-- @if (old('prodi'))
                                                @foreach (old('prodi') as $i => $mm)
                                                    @foreach ($jurusan as $j)
                                                        @if ($j->idx == $mm)
                                                            <option selected value="{{ $j->idx }}">
                                                                {{ $j->text }}
                                                            </option>
                                                        @endif
                                                    @endforeach
                                        ...
                                        <div class="col-6">
                                            <select class="akreditasi js-example-responsive form-select"
                                                name="akreditasi[]" style="width: 100%">
                                                <option selected value="{{ $fixprodi[0] }}">{{ $fixprodi[0] }}
                                                </option>
                                    ...
                                    @foreach ($panels as $panel)
                                        <div class="col-6 my-1">
                                            <div class="form-check">
                                                ...
                                                <input class="form-check-input" type="checkbox"
                                                    name="{{ $panel['id_panel'] }}" id="{{ $panel['id_panel'] }}"
                                                    @foreach ($hak_akses_panel as $fixpanel)
                                                        @if ($panel['id_panel'] == $fixpanel['id_panel']) checked @endif @endforeach>
                                                <label class="form-check-label" for="{{ $panel['id_panel'] }}">
                                                    {{ $panel['nama_panel'] }}
                                                </label>
                                            </div>
