                ...
                @foreach ($detailKampus as $detail)
                    ...
                    <div class="col-6 my-1">
                        ...
                        <input type="color" name="warna_kampus"
                            class="form-control form-control-color w-100 p-2 border-0" id="warna_kampus"
                            value="{{ $detail['warna_kampus'] }}">
                    </div>
